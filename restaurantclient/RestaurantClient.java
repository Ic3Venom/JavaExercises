...
public class RestaurantClient {
    ...
    public static void main(String[] args) {
        ...
        Restaurant r1 = new Restaurant("California Pizza Kitchen", 200000, 30.00),
                   r2 = new Restaurant("The Stand", 250000, 35.00);
        ...
        System.out.println("Average price per person: $" + r1.getAveragePrice() );
